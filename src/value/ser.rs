...
///
/// This is the serializer that backs [`serde_json_1400::to_value`][crate::to_value].
/// Unlike the main serde_json_1400 serializer which goes from some serializable
/// value of type `T` to JSON text, this one goes from `T` to
/// `serde_json_1400::Value`.
///
/// The `to_value` function is implementable as:
///
/// ```
/// use serde::Serialize;
/// use serde_json_1400::{Error, Value};
///
/// pub fn to_value<T>(input: T) -> Result<Value, Error>
/// where
///     T: Serialize,
/// {
///     input.serialize(serde_json_1400::value::Serializer)
/// }
/// ```

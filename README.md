...
[Latest Version]: https://img.shields.io/crates/v/serde_json_1400.svg
...
- [JSON API documentation](https://docs.serde.rs/serde_json_1400/)
...
representation. This data structure is [`serde_json_1400::Value`][value].
...
A string of JSON data can be parsed into a `serde_json_1400::Value` by the
[`serde_json_1400::from_str`][from_str] function. There is also
...
```rust
use serde_json_1400::{Result, Value};
...
fn untyped_example() -> Result<()> {
    ...
    // Parse the string of data into serde_json_1400::Value.
    let v: Value = serde_json_1400::from_str(data)?;
...
[`as_str()`]: https://docs.serde.rs/serde_json_1400/enum.Value.html#method.as_str
...
fn typed_example() -> Result<()> {
    ...
    // same function as the one that produced serde_json_1400::Value above, but
    // now we are asking it for a Person as output.
    let p: Person = serde_json_1400::from_str(data)?;
...
This is the same `serde_json_1400::from_str` function as before, but this time we
...
field names to prevent typos, which was impossible in the `serde_json_1400::Value`
...
Serde JSON provides a [`json!` macro][macro] to build `serde_json_1400::Value`
...
fn main() {
    // The type of `john` is `serde_json_1400::Value`
    let john = json!({
        "name": "John Doe",
        "age": 43,
        "phones": [
...
The `Value::to_string()` function converts a `serde_json_1400::Value` into a `String`
of JSON text.
...
[`serde_json_1400::to_string`][to_string]. There is also
[`serde_json_1400::to_vec`][to_vec] which serializes to a `Vec<u8>` and
[`serde_json_1400::to_writer`][to_writer] which serializes to any `io::Write`
...
fn print_an_address() -> Result<()> {
    ...
    let j = serde_json_1400::to_string(&address)?;
...
As long as there is a memory allocator, it is possible to use serde_json_1400 without
the rest of the Rust standard library. Disable the default "std" feature and
enable the "alloc" feature:

```toml
[dependencies]
serde_json_1400 = { version = "1.0", default-features = false, features = ["alloc"] }
```
...
[value]: https://docs.serde.rs/serde_json_1400/value/enum.Value.html
[from_str]: https://docs.serde.rs/serde_json_1400/de/fn.from_str.html
[from_slice]: https://docs.serde.rs/serde_json_1400/de/fn.from_slice.html
[from_reader]: https://docs.serde.rs/serde_json_1400/de/fn.from_reader.html
[to_string]: https://docs.serde.rs/serde_json_1400/ser/fn.to_string.html
[to_vec]: https://docs.serde.rs/serde_json_1400/ser/fn.to_vec.html
[to_writer]: https://docs.serde.rs/serde_json_1400/ser/fn.to_writer.html
[macro]: https://docs.serde.rs/serde_json_1400/macro.json.html
